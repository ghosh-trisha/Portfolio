                ...
                >
                    <defs>
                        ...
                        >
                            ...
                            <stop offset={0} stopColor="#7D577E" />
                            <stop offset={0.01} stopColor="#7D577E" />
                            <stop offset={0.19} stopColor="#7C5C73" />
                            <stop offset={0.35} stopColor="#7C5C73" />
                    ...
                    <g className="me" clipPath="url(#a)">
                        <g className="body drop-shadow-xl">
                            <path
                                ref={HairBack}
