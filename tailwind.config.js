  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'c-img-card-purple': '-3px 10px 30px 1px #C07ABE',
        'c-img-card-purple-hover-left-pic': '6px 8px 40px 9px #C07ABE',
        'c-img-card-purple-hover-right-pic': '-6px 8px 40px 9px #C07ABE',
        'c-img-card': '0 0px 0px 10px #C07ABE',
      },
      dropShadow:{
